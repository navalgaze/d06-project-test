"""
Django settings for d06_project_test project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-^g$!udyy^_4gcdsge+-bk6%yt#l@n%%6vqz6kmnc62v*e42!0-')
...
ROOT_URLCONF = 'd06_project_test.urls'
...
WSGI_APPLICATION = 'd06_project_test.wsgi.application'
